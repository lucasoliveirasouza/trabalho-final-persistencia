	...
	<div class="container-fluid d-flex justify-content-center info-vacina">
		<div class="w-100 mt-3">
			<ul style="list-style-type: none; font-size:18pt; color: var(--bs-gray-700);">
				<li>Nome da vacina: <%=vacina.getTitulo()%></li>
				<li>Informações: <%=vacina.getDescricao()%></li>
				<li>Doses necessárias: <%=vacina.getDoses()%></li>
			<% if (vacina.getPeriodicidade() == 1) {%>
				<li>Periodicidade: Dias</li>
			<%}else if(vacina.getPeriodicidade() == 2){%>
				<li>Periodicidade: Semanas</li>
			<%}else if (vacina.getPeriodicidade() == 3) {%>
				<li>Periodicidade: Meses</li>
			<%}else{%>
				<li>Periodicidade: Anos</li>
			<%} %>
			</ul>
		</div>
	</div>	
